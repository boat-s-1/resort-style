  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{ fontSize: '13px', color: '#666', marginTop: '15px', lineHeight: '1.6' }}>
        <p>【当店は風俗的サービスは一切行っておりません。】
当店は、風俗店・医療法が定める病院・診療所・鍼灸による施術所ではございません。
施術前のシャワーと、施術中の紙ショーツご着用を必ずお願い致します。
下半身を露出させる行為・自慰行為・性的サービスの要求を固く禁止致します。
セラピストが最高のサービスを出来るよう、以下のご注意事項をお守り頂きますようお願い申し上げます。

下記事項をご確認、同意の上ご利用下さい。

当店は風俗系マッサージ、回春エステ店ではございません。
また、回春マッサージ等の法令及び公序良俗に反するような行為も一切行っておりません。

性的サービスはいかなる場合も一切行っておりません。

医療行為を目的としたマッサージ店ではありません。

未成年者・暴力団関係者・刺青のある方・薬物使用者・泥酔者のご利用もお断りさせて頂きます。

セラピストへのボディータッチ・性的サービスの強要は禁止です。

セラピストへの痴漢行為、言葉でのセクハラ行為、ストーカー行為、店外への誘いは禁止です。

ビデオカメラ・カメラ付携帯・等の機器による撮影等一切禁止です。

同業者および準ずる方のスカウト行為、勧誘など固くお断りさせて頂いております。

ルーム内は電子タバコを含む終日禁煙となります。

施設内での盗難、紛失につきましては、当店またはその関係者に一切の賠償責任はございません。

当店では、安全管理に万全を期しておりますが、不慮の事故、皮膚のかぶれ、もみかえし等が生じた場合、当店またはその関係者に一切の賠償責任はございません。


セラピストが施術続行不可能と判断した場合、直ちに施術を中止し、ご退出頂く場合がございます。 その際の料金のご返金は致しかねますのでご了承下さい。
又、損害賠償請求、法的措置等も視野にいれた、しかるべき対応をとらせて頂きます。
注意事項違反によってセラピストが身体的苦痛・肉体的苦痛を受け、休業や退店などが伴う場合は、公的機関を通し損害賠償請求等の対応をとらせて頂きます。
